...
kable(Fogel2017_ReportedCorMat, "latex",  digits = 3, caption = "Correlations between Microstructure Behaviors - Simulated", row.names = FALSE) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
\FloatBarrier
...
kable(Fogel2017_corMat, "latex",  digits = 3, caption = "Correlations between Microstructure Behaviors - Simulated", row.names = FALSE) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```

###Corrleations Simulated - After Rounding Simulated Number of Bites

```{r Fogel2017_microstructureSim_BiteRound_cortab, echo=FALSE, results='asis'}
kable(Fogel2017_BiteRound_corMat, "latex",  digits = 3, caption = "Correlations between Microstructure Behaviors - Simulated, Rounded", row.names = FALSE) %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
...
\begin{tabular}{lll@{\hspace{5pt}}lll@{\hspace{5pt}}ll}
  ...
  Total Intake \scriptsize{(kCal)} & 175.3 (6.09) && 306.7 (9.9) && 11.28 & <0.001\\
  \hline
\end{tabular}
\end{table}

###Means (SEM) After Rounding Simulated Number of Bites


##Parameter Distributions - Quadratic

##Parameter Distributions - First Principles Model

```{r Hist_theta_logitBiteSim, echo=FALSE, include = FALSE}
SimDat_Fogel2017_thetaHist
```

```{r Hist_theta_logitBiteSim_ERgroup, echo=FALSE, include = FALSE}
SimDat_Fogel2017_thetaHist_group
```

```{r Hist_r_logitBiteSim, echo=FALSE, include = FALSE}
SimDat_Fogel2017_rHist
```

```{r Hist_r_logitBiteSim_ERgroup, echo=FALSE, include = FALSE}
SimDat_Fogel2017_rHist_group
```

```{r Hist_Emax_logitBiteSim, echo=FALSE, include = FALSE}
SimDat_Fogel2017_EmaxHist
```

```{r Hist_Emax_logitBiteSim_ERgroup, echo=FALSE, include = FALSE}
SimDat_Fogel2017_EmaxHist_group
```

###Histogram: Overall Distributions

\begin{figure}[ht!]
  \centering
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering $\theta$}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Hist_theta_logitBiteSim-1.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering r}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Hist_r_logitBiteSim-1.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering Emax }
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Hist_Emax_logitBiteSim-1.pdf}
  \end{subfigure}
\end{figure}

\FloatBarrier

###Histogram: Distributions by Eating Rate Group

\begin{figure}[ht!]
  \centering
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering $\theta$ by Eating Rate Group}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Hist_theta_logitBiteSim_ERgroup-1.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering r by Group}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Hist_r_logitBiteSim_ERgroup-1.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering Emax by Group}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Hist_Emax_logitBiteSim_ERgroup-1.pdf}
  \end{subfigure}
\end{figure}

###Density: Distributions by Eating Rate Group

\FloatBarrier

```{r Dist_theta_logitBiteSim_ERgroup, echo=FALSE, include = FALSE}
SimDat_Fogel2017_thetaDist_group
```

```{r Dist_r_logitBiteSim_ERgroup, echo=FALSE, include = FALSE}
SimDat_Fogel2017_rDist_group
```

```{r Dist_Emax_logitBiteSim_ERgroup, echo=FALSE, include = FALSE}
SimDat_Fogel2017_EmaxDist_group
```
...
\begin{figure}[ht!]
  ...
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering $\theta$ by Eating Rate Group}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Dist_theta_logitBiteSim_ERgroup-1.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering r by Group}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Dist_r_logitBiteSim_ERgroup-1.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{=0.40\textwidth}
    \centering
    \caption*{\centering Emax by Group}
    \includegraphics[width=\textwidth]{FPM_SimStudy_figs/fig-Dist_Emax_logitBiteSim_ERgroup-1.pdf}
  \end{subfigure}
\end{figure}
